...
const (
	Greeter_GetStream_FullMethodName = "/hello.Greeter/GetStream"
	Greeter_PutStream_FullMethodName = "/hello.Greeter/PutStream"
	Greeter_AllStream_FullMethodName = "/hello.Greeter/AllStream"
)
